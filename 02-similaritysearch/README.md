## FAISS & OpenAI
....
- This is an application which generates text, based on a user input and the context retrieved from a vector store (FAISS: Facebook AI Similarity Search).
- To perform the generation, this application uses OpenAI API and LangChain together.
...
## Installation: Install the dependencies using the following command
**on /*NIX**:
```
...
Add your OpenAI API key to `.env` file as:
